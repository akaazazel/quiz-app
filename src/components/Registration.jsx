...
export default function Registration() {
  ...
  return (
    <div className="container center" style={{ marginTop: '2rem', marginBottom: '4rem' }}>
      <div className="card" style={{ maxWidth: '600px', width: '100%' }}>
        <h1 style={{ marginBottom: '1.5rem', textAlign: 'center' }}>Quiz Registration</h1>
        ...
        <form onSubmit={handleSubmit} className="stack">
          ...
          <div className="form-group">
            <label htmlFor="institution_name" className="label">
                {formData.institution_type === 'school' ? 'School Name' : 'College Name'}
            </label>
            <input
              type="text"
              id="institution_name"
          ...
          {formData.institution_type === 'school' && (
             <div className="form-group">
                <label htmlFor="class_grade" className="label">Class / Grade</label>
                <input
                    type="text"
                    id="class_grade"
                    name="class_grade"
